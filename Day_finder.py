#Day Finder. Between the years 1500-2299
# Program to know what day will be on a particular date. 
...
def main():
 ...
 try:
  ...
  if feb_28 or month_31 or month_30 or mt>12 or year>=2300 or leap_feb_29:
 ...
 if year>2100:
     day+=1
 sday={1:'Sunday',2:'Monday',3:'Tuesday',4:'Wednesday',5:'Thursday',6:'Friday',0:'Saturday'}
 for i in sday:
  if i==day:
